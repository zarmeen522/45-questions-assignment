...
//NUMERIC TESTS:
let her_income:number= 35499;
let her_age:number=27
let her_overall_costs:number=27800;
let her_savings:number=7699;
...
//TESTS using AND & OR:
let my_friends:string="Rubab";
let not_my_friend :string="Fatima";
// for false:
...
let number1: number[]= [26 ,17 ,47 ,85 ,29 ,72 ,93];
